...
public class ExG4 {
	...
	public static void main(String[] args) {
		...
		try {
			Instructor instr1 = new Instructor("Cecile", "Navez", LocalDate.of(1974,1,3), 27, 3000.0);
			instr1.printSalaryHistory("cecile.txt"); // dans fichier cecile.txt
						
			Instructor instr2 = new Instructor("Philippe", "Dupont", LocalDate.of(1970,2,16), 20, 1500.0);
